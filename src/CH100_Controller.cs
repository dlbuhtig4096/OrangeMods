...
public class CH100_ShungokusatsuDummy : CollideBullet_ {
    ...
    public override void OnTriggerUpdate(Collider2D col) {
        ...
        if (this._player.CurMainStatus == OrangeCharacter.MainStatus.SKILL && this._player.CurSubStatus == OrangeCharacter.SubStatus.SKILL1_1) {
            this.CallBase<CollideBullet, Action<Collider2D>>("OnTriggerUpdate", col); // base.OnTriggerStay2D(col);
        }
    }
...
public class CH100_Controller : CharacterControlBase_ {
